...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-twitter-stream-channels/node_modules/twitter-stream-channels/lib/TwitterStreamChannels.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header medium">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-twitter-stream-channels/node_modules/twitter-stream-channels/lib/TwitterStreamChannels.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-twitter-stream-channels/node_modules/twitter-stream-channels/lib/</a> &#187; TwitterStreamChannels.js</div>
</div>
<div class="body">
 ...
 */
var TwitterStreamChannels = <span class="fstat-no" title="function not covered" >function(credentials) {</span>
<span class="cstat-no" title="statement not covered" >  this.apiClient = new twit(credentials);</span>
};
&nbsp;
/**
 ...
 */
TwitterStreamChannels.getMockedClass = <span class="fstat-no" title="function not covered" >function(){</span>
<span class="cstat-no" title="statement not covered" >  return require('../mocks/TwitterStreamChannels');</span>
};
&nbsp;
/**
 ...
 */
TwitterStreamChannels.launchMockDataRetriever = <span class="fstat-no" title="function not covered" >function(credentials,options){</span>
<span class="cstat-no" title="statement not covered" >  return new require('./MockDataRetriever')(credentials,options);</span>
};
&nbsp;
/**
 ...
 * @returns {twit}
 */
TwitterStreamChannels.prototype.getApiClient = <span class="fstat-no" title="function not covered" >function() {</span>
<span class="cstat-no" title="statement not covered" >  return this.apiClient;</span>
};
&nbsp;
/**
 ...
 */
TwitterStreamChannels.prototype.streamChannels = <span class="fstat-no" title="function not covered" >function(options) {</span>
<span class="cstat-no" title="statement not covered" >  return new StreamChannels(this.apiClient, options);</span>
};
&nbsp;
